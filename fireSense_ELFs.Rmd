...
This module makes the national ELF maps and the study area objects every other fireSense module uses: `studyArea`, `studyAreaLarge`, `rasterToMatch`, their `*ELF` versions, `sppEquiv` and `studyAreaPSP`.
